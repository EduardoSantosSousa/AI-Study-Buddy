...
mcq_prompt_template = PromptTemplate(
    template=(
        ...
        "The quiz already has these questions:\n"
        "{existing_questions}\n\n"
        "Generate a NEW question that is meaningfully different from every question above.\n"
        "Do not repeat the same concept, wording, answer, or example.\n\n"
    ...
    input_variables=["topic", "difficulty", "existing_questions"]
)
